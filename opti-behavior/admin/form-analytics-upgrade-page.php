	...
	<div class="recordings-header">
		<div class="recordings-header-content">
			<div class="recordings-title-section">
				<div class="recordings-icon"><i data-lucide="file-input"></i></div>
				<div class="recordings-title-text">
					<h1 class="recordings-title"><?php esc_html_e( 'Form Analytics', 'opti-behavior' ); ?></h1>
					<div class="recordings-subtitle"><?php esc_html_e( 'Track form interactions, field drop-offs, and optimize conversion rates.', 'opti-behavior' ); ?></div>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="recordings-upgrade-content">
		<div class="upgrade-card">
			...
			<p class="upgrade-description">
				<?php esc_html_e( 'Form Analytics is a powerful premium module that reveals exactly how users interact with your forms — which fields cause confusion, where they drop off, and how to improve conversion rates.', 'opti-behavior' ); ?>
				<br />
				<?php esc_html_e( 'Get full access to all Pro features for 6 months — completely free, no credit card required. Privacy-first analytics for your WordPress forms.', 'opti-behavior' ); ?>
			</p>

			<div class="upgrade-features">
				<h3><?php esc_html_e( 'What you get with Form Analytics:', 'opti-behavior' ); ?></h3>
				<ul class="features-list">
					<li><i data-lucide="check-circle"></i> <?php esc_html_e( 'Field-by-field drop-off funnel visualization', 'opti-behavior' ); ?></li>
					<li><i data-lucide="check-circle"></i> <?php esc_html_e( 'Per-field metrics: time spent, error rate, refill rate', 'opti-behavior' ); ?></li>
					<li><i data-lucide="check-circle"></i> <?php esc_html_e( 'Form conversion rate and abandonment tracking', 'opti-behavior' ); ?></li>
					<li><i data-lucide="check-circle"></i> <?php esc_html_e( 'Identify problem fields that cause users to leave', 'opti-behavior' ); ?></li>
					<li><i data-lucide="check-circle"></i> <?php esc_html_e( 'Works with WooCommerce, Contact Form 7, WPForms, and more', 'opti-behavior' ); ?></li>
					<li><i data-lucide="check-circle"></i> <?php esc_html_e( 'Privacy-first: no form values are ever captured', 'opti-behavior' ); ?></li>
				</ul>
			</div>
			...
			<div class="upgrade-cta">
				...
				<p class="cta-text">
					<?php esc_html_e( 'Download the Pro version now and get access to Form Analytics and all premium features for 6 months — completely free. No credit card, no commitment.', 'opti-behavior' ); ?>
				</p>
